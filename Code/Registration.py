...
#         print(np.where(quality >= tau_max)[0].shape[0])
...
#         print([np.repeat(np.reshape(C[:, 1], [cnt, 1]), cnt, axis=1),
#                 np.repeat(np.reshape(C[:, 0], [1, cnt]), cnt, axis=0)])
#         print(np.shape(np.repeat(np.reshape(C[:, 1], [cnt, 1]), cnt, axis=1)))
#         print(np.repeat(np.reshape(C[:, 1], [cnt, 1]), cnt, axis=1))
#         print(np.shape(np.repeat(np.reshape(C[:, 0], [1, cnt]), cnt, axis=0)))
#         print(np.repeat(np.reshape(C[:, 0], [1, cnt]), cnt, axis=0))
